...
public class CodeSandbox : MonoBehaviour
{
    void Start()
    {
        ...
        Statistic areaStatistic1 = new Statistic(StatisticsEnum.AreaOfEffect, 5f);
        ...
        print("areaStatistic1: " + areaStatistic1.Current.ToString());

        domageModifier1.AddStatistic(domageStatistic1);
        domageModifier1.AddStatistic(domageStatistic2);
        domageModifier1.AddStatistic(areaStatistic1);

        print("domageStatistic1: " + domageStatistic1.Current.ToString());
        print("areaStatistic1: " + areaStatistic1.Current.ToString());

        domageModifier1.RemStatistic(domageStatistic1);
        domageModifier2.AddStatistic(domageStatistic2);

        print("domageStatistic1: " + domageStatistic1.Current.ToString());
        print("domageStatistic2: " + domageStatistic2.Current.ToString());
        print("areaStatistic1: " + areaStatistic1.Current.ToString());
